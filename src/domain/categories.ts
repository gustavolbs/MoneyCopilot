...
export const defaultCategories: Category[] = [
  ...
  { id: 'cat_expense_food', household_id: null, name: 'Comer fora/Delivery', type: 'expense', icon: 'utensils', color: '#F9735B', is_default: true, created_at: now, updated_at: now, deleted_at: null },
...
export const keywordCategoryMap: Array<{ keywords: string[]; categoryId: string; type?: 'income' | 'expense' }> = [
  ...
  { keywords: ['outback', 'restaurante', 'restaurantes', 'ifood', 'delivery', 'pizza', 'hamburguer', 'jantar', 'almoco', 'lanche'], categoryId: 'cat_expense_food', type: 'expense' },
