...
export const defaultCategories: Category[] = [
  ...
  { id: 'cat_expense_utilities', household_id: null, name: 'Energia/Água', type: 'expense', icon: 'zap', color: '#EAB308', is_default: true, created_at: now, updated_at: now, deleted_at: null },
  ...
  { id: 'cat_expense_family', household_id: null, name: 'Família', type: 'expense', icon: 'users', color: '#84CC16', is_default: true, created_at: now, updated_at: now, deleted_at: null },
