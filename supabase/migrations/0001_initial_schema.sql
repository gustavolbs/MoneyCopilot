...
values
  ('cat_income_salary', null, 'Salario', 'income', 'briefcase', '#2F80ED', true),
  ...
  ('cat_expense_food', null, 'Alimentacao', 'expense', 'utensils', '#F59E0B', true),
  ...
  ('cat_expense_utilities', null, 'Energia/Agua', 'expense', 'zap', '#EAB308', true),
